...
## Rich Menu (เมนูถาวรด้านล่างแชท)

ตั้งครั้งเดียว — เมนูจะแสดงตลอดในทุกแชท

```bash
pip install Pillow          # ติดตั้งครั้งเดียว (บน local ไม่ต้องใส่ Docker)
python setup_richmenu.py    # สร้างและ upload เมนูขึ้น LINE
```
